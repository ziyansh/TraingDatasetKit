"""
Move or Delete Files Tab UI 组件 - 移动或删除文件
...
class MoveOrDeleteFilesUI(UIBase):
    ...
    def set_callbacks(self, o_update_filter_and_gallery: List[gr.components.Component], 
                     dataset_gallery: DatasetGalleryUI, filter_by_tags: FilterByTagsUI, 
        ...
        def _get_current_move_or_delete_target_num():
            if self.target_data == 'Selected One':
                ...
                self.current_target_txt = 'Target dataset num: 0'
            return self.current_target_txt
        ...
        def move_files(target_data: str, target_file, caption_ext: str, dest_dir: str):
        ...
        self.btn_move_or_delete_move_files.click(
            fn=move_files,
            inputs=[self.rb_move_or_delete_target_data, self.cbg_move_or_delete_target_file, 
                   self.tb_move_or_delete_caption_ext, self.tb_move_or_delete_destination_dir],
            outputs=o_update_filter_and_gallery
        )
        self.btn_move_or_delete_move_files.click(**update_args)

        def delete_files(target_data: str, target_file, caption_ext: str):
