"""
Dataset Gallery UI 组件 - 数据集图片画廊

适配说明：
- 移除 modules.shared / modules.shared.opts 依赖
- 移除 _js 回调（JavaScript 依赖 webui）- 保留基本功能
"""
...
class DatasetGalleryUI(UIBase):
    ...
    def set_callbacks(self, load_dataset: LoadDatasetUI, gallery_state: GalleryStateUI, 
