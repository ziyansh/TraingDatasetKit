...
class TagSelectUI:
    ...
    def create_ui(self, get_filters: Callable[[], List[Filter]], 
                  sort_by=SortBy.ALPHA, sort_order=SortOrder.ASC, 
    ...
    def btn_deselect_visibles_clicked(self, cbg_tags):
    ...
    def cbg_tags_update(self):
        ...
        self.tags = set(dte_instance.get_filtered_tags(self.get_filters(), filter_tags=True, 
                                                       prefix=self.prefix, suffix=self.suffix, regex=self.regex))
